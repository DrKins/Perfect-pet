  ...
  <div class="landing">
    ...
    <div class="containerBox" :class="{ flyoutContent: FlyOut }">
      ...
      <div class="btn-container">
        ...
        <button class="btn-randomize" v-on:click="randomize">
          <img src="../assets/shuffle.png" alt="randomize" title="randomize" />
        </button>
      </div>
      <!-- x1,x2,x3,x4 are div classes that represents css clouds -->
      <div
        v-for="(item, index) in ['x1', 'x2', 'x3', 'x4', 'x5', 'x6']"
        :key="index"
      >
